<div class="news_item card w-100">
    <div class="card-body">
      ...
      <p>Category: 
        <a href="{{ route('singleCategory', $news_item->category_id) }}">{{ $news_item->name }}</a>
      </p>
      <div class="news_info">
        <a href="{{ route('singleNews', $news_item->news_id) }}" class="btn btn-primary">Read the full story</a>
